...
const Header = ({ title, greeting, description }) => {
  return (
    <div>
      <h1 className="mb-2 text-lg font-bold text-zinc-700">{greeting}</h1>
      <h1 className="text-4xl text-start font-semibold">{title}</h1>
